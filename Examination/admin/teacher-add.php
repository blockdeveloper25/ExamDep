...
if (
  ...
  if ($_SESSION['role'] == 'admin') {
    ...
    if (isset($_GET['course'])) $modules = $_GET['course'];
    if (isset($_GET['dep'])) $department = $_GET['dep'];
    if (isset($_GET['role'])) $department = $_GET['role'];
    if (isset($_GET['fac'])) $faculty = $_GET['fac'];
      ...
      <div class="container mt-5">
        ...
        <form method="post" class="shadow p-3 mt-5 form-w" action="req/teacher-add.php">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" value="<?= $faculty ?>" name="fac">
          </div>
          <div class="mb-3">
            <label class="form-label">Department</label>
            <input type="text" class="form-control" value="<?= $department ?>" name="dep">
          </div>
          <div class="mb-3">
            <label class="form-label">Course</label>
            <input type="text" class="form-control" value="<?= $course ?>" name="course" placeholder="Don't Add Spaces between Commas">
          </div>
          <div class="mb-3">
