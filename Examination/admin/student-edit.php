      ...
      <div class="container mt-5">
        ...
        <form method="post" class="shadow p-3 mt-5 form-w" action="req/student-edit.php">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" value="<?= $student['faculty'] ?>" name="course">
          </div>
          <div class="mb-3">
            <label class="form-label">Department</label>
            <input type="text" class="form-control" value="<?= $student['department'] ?>" name="course">
          </div>
          <div class="mb-3">
          ...
          <input type="text" value="<?= $student['user_id'] ?>" name="student_id" hidden>
